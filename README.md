...
### 1. [Tech Industry Layoffs Analysis](./01_Tech_Layoffs_Analysis/)
...
* **Concepts:** CTEs, Window Functions (Rank, Row_Number, Lead/Lag), Staging Tables, Schema Design, Performance Tuning (Indexing).
* **Tools:** DBeaver, MySQL Workbench, Git.
...
3. **Imputation:** Handling null values through logical joins.
4. **Analysis:** Developing KPIs and trend reports for stakeholders.

---
**Let's Connect!**
[LinkedIn](https://www.linkedin.com/in/pneelakantam/) | [Email](mailto:pvneelakantam@gmail.com)
